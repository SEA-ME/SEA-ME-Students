...
int main()
{
    std::shared_ptr<Car> car1 = std::make_shared<Car>("Cheap", 100, "Toyota", "Camry", 2020);
    car1->drive();

    std::shared_ptr<SportsCar> sportsCar1 = std::make_shared<SportsCar>("Expensive", 200, "BMW", "520D", 2021, 300);
    sportsCar1->drive();

    std::shared_ptr<Vehicle> vehicle1 = car1;
    std::shared_ptr<Vehicle> vehicle2 = sportsCar1;
